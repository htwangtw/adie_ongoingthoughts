...
if save == 1:
    ...
    participants = pd.read_csv('/research/cisc2/projects/critchley_adie/BIDS_data/participants.tsv', sep='\t')
    ...
    df_master.to_csv('/research/cisc2/projects/critchley_adie/BIDS_data/participants2.tsv')
