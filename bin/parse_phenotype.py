...
demographics = ["Age", "GenderID", "GenderBirth", "GenderFit", "Education", "Handedness", "Nationality"]
...
for name, cat in zip(["demographics", "height_weight", "diagnosis", "admin"], # Variable 'name' string. Function 'zip' allows multiple column names into for loop
    ...
    cur_df = df[cat].fillna("n/a") # Fills blank cells in selected category of df with 'n/a'
